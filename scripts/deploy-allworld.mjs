...
/**
 * Upload dist/ to:
 *   1) R2 26-xb-res-bid-assets  (project bucket)
 *   2) R2 allworld-sites/26-xb-res-bid/  (shared Allworld host)
 */
...
const siteId = process.argv[2] || '26-xb-res-bid'
const projectBucket = '26-xb-res-bid-assets'
